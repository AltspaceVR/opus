# from stack overflow
# http://stackoverflow.com/questions/17869333/makefile-needed-for-compiling-the-opus-codec-for-android
...
LOCAL_CFLAGS += -Drestrict='' -D__EMX__ -DOPUS_BUILD -DFIXED_POINT -DDISABLE_FLOAT_API -DUSE_ALLOCA -DHAVE_LRINT -DHAVE_LRINTF -DAVOID_TABLES
